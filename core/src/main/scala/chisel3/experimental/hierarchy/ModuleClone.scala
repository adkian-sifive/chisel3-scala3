...
private[chisel3] class ModuleClone[T <: BaseModule](val getProto: T)
  ...
  override def addId(d: HasId) = ArrayBuffer[HasId]()
  ...
  private[chisel3] var _portsRecord: Record = scala.compiletime.uninitialized
